...
def show_cpu_mem_usage():
    ...
    time_str = "2025-09-18 18:48:58.118213"
    dt = datetime.strptime(time_str, "%Y-%m-%d %H:%M:%S.%f")
    last_one_hour = dt - timedelta(hours=1) 
    ...
    for ip in device_list:
        ...
        color_id += 1
    # 定义PNG图片的存储路径及文件名
    cpu_usage_filename = f'{save_dir}{os.sep}cpu_usage.png'
    mem_usage_filename = f'{save_dir}{os.sep}mem_usage.png'
